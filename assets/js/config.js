window.RIYADH_CONFIG = {
  ...
  policy: {
    ...
    acceptance: [
      ...
      'في حال الرفض وفق سياسة الجروب أو لمخالفة الإعلان لسياسة النشر على فيسبوك، تُعاد الرسوم كاملةً عبر PayPal بعد إلغاء الدفعة من لوحة الجروب، ويُبلَّغ المتقدّم وفق ما تراه الإدارة داخل الجروب.'
    ],
    guaranteeNote: 'الدفع لا يضمن النشر، والقبول النهائي خاضع لسياسة الجروب واشتراط عدم مخالفة الإعلان لسياسة النشر على فيسبوك.',
    refundNote: 'الاسترداد: في حال رفض الإعلان وفق سياسة الجروب، تُعاد الرسوم كاملةً عبر PayPal دون أي اقتطاع.'
  },
  ...
  paypal: {
    ...
    currency: 'USD',
    currencyNote: 'يُحاسَب المبلغ عبر PayPal بالدولار الأمريكي (USD) بقيمة معادلة ثابتة: 40 ريال = 10.67 دولار، و80 ريال = 21.33 دولار. تُودَع الأموال في حساب الجروب مباشرة، ويُتحقق من الدفع قبل النشر.',
    badge: 'PayPal'
  },
