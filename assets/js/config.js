window.RIYADH_CONFIG = {
  ...
  paypal: {
    ...
    currency: 'USD',
    methods: ['حساب PayPal', 'بطاقة السحب أو الائتمان (فيزا / ماستركارد)'],
    methodHint: 'الدفع يتم عبر PayPal بأمان، باستخدام حسابك أو بطاقتك البنكية مباشرة دون الحاجة لإنشاء حساب PayPal.',
