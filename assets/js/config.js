window.RIYADH_CONFIG = {
  ...
  policy: {
    reviewHours: 12,
    privacy: [
      'لا نطلب أي بيانات مالية حساسة؛ يتم الدفع بالكامل عبر PayPal بأمان — بحساب PayPal، أو Apple Pay، أو البطاقات البنكية (Visa / Mastercard) مباشرةً.',
  ...
  paypal: {
    ...
    currency: 'USD',
    currencyNote: 'يُحاسَب المبلغ عبر PayPal بالدولار الأمريكي بقيمة معادلة ثابتة (40 ريال ≈ 10.67$ و80 ريال ≈ 21.33$)، وتُودَع الأموال في حساب الجروب مباشرة. يمكنك الدفع بحساب PayPal أو ببطاقتك البنكية مباشرةً دون الحاجة لإنشاء حساب.',
    badge: 'PayPal'
  },
